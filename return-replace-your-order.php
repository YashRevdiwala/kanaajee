...
if (localStorage) {
  ...
  #clevertap-frame{
    ...
    <title>Return/Replace your order</title><meta name="description" content="To Return Product please enter your Order ID and Email in the box below and press the &quot;Submit&quot; button. These were given to you on your receipt and in the confirmation email you should have received."><link rel="canonical" href="https://peachmode.com/pages/return-replace-your-order"><link rel="shortcut icon" href="img/1.png"><link rel="preconnect" href="https://cdn.shopify.com">
...
window.dataLayer = window.dataLayer || [];
  ...
  <meta property="og:title" content="Return/Replace your order"><meta property="og:image" content="http://cdn.shopify.com/s/files/1/0637/4834/1981/files/Peachmode_Logo.png?v=1649671323">
  ...
  <meta property="og:image:height" content="628"><meta property="og:description" content="To Return Product please enter your Order ID and Email in the box below and press the &quot;Submit&quot; button. These were given to you on your receipt and in the confirmation email you should have received."><meta property="og:url" content="https://peachmode.com/pages/return-replace-your-order">
<meta property="og:site_name" content="Peachmode"><meta name="twitter:card" content="summary"><meta name="twitter:title" content="Return/Replace your order">
  <meta name="twitter:description" content="To Return Product please enter your Order ID and Email in the box below and press the &quot;Submit&quot; button. These were given to you on your receipt and in the confirmation email you should have received."><meta name="twitter:image" content="https://cdn.shopify.com/s/files/1/0637/4834/1981/files/Peachmode_Logo_1200x1200_crop_center.png?v=1649671323">
...
<script id="__st">var __st={"a":63748341981,"offset":19800,"reqid":"a3cd4387-e3ea-47fe-9df3-8faf1732863c","pageurl":"peachmode.com\/pages\/return-replace-your-order","s":"pages-98220081373","u":"ecfe401fa6e7","p":"page","rtyp":"page","rid":98220081373};</script>
...
<script>window.performance && window.performance.mark && window.performance.mark('shopify.content_for_header.end');</script>
	...
	<script>var loox_global_hash = '1681308055903';</script><style>.loox-reviews-default { max-width: 1200px; margin: 0 auto; }.loox-rating .loox-icon { color:#fed264; }</style><script>var loox_rating_icons_enabled = true;</script>
...
var meta = {"page":{"pageType":"page","resourceType":"page","resourceId":98220081373}};
...
<script class="analytics">(function () {
  ...
  trekkie.ready(function() {
    ...
    window.ShopifyAnalytics.lib.page(null,{"pageType":"page","resourceType":"page","resourceId":98220081373});
...
<script type="application/ld+json">
...
</div><div id="main" role="main" class="anchor"><div id="shopify-section-template--16083819462877__main" class="shopify-section shopify-section--main-page"><style>
  @media (max-width:600px){
    ...
    #return_request .table-shipment + .table.mb-1 tbody tr:not(.d-flex-mobile) td{
      padding:0 !important;
    }
     #return_request .table-shipment + .table.mb-1 tbody tr td:first-of-type{
       font-weight:bold;
     }
    #return_request .table-shipment + .table.mb-1 tbody tr  td:last-of-type{
...
/*     .d-flex-mobile td{
    ...
    #return_request .table-shipment + .table.mb-1 tbody tr.d-flex-mobile td:last-of-type{      
    ...
    <div class="page-header">
      <nav aria-label="Breadcrumb" class="breadcrumb breadcrumb--floating text--xsmall hidden-phone">
        <ol class="breadcrumb__list" role="list">
          ...
          <li class="breadcrumb__item">
            <span class="breadcrumb__link" aria-current="page">Return/Replace your order</span>
          </li>
        </ol>
      </nav>

      <div class="page-header__text-wrapper text-container"><h1 class="heading h2">Return/Replace your order</h1></div>
    </div>
   <div class="page-content page-content--medium rte"><span>To Return Product please enter your Order ID and Email in the box below and press the "Submit" button. These were given to you on your receipt and in the confirmation email you should have received.</span><p id="trackerError"></p>
     <form id="return-order-form"  method="post" class="mt-4">
      <div class="input">
              <input id="orderid" type="text" class="input__field" name="orderid" aria-label="orderid" required >
        <label for="orderid" class="input__label">Order ID* <small>(Found in your order confirmation email.)</small></label>
            </div>
        <div class="input">
              <input id="billing_email" type="email" class="input__field " name="billing_email" aria-label="billing_email"  >
          <label for="billing_email" class="input__label">Billing Email <small>(Email you used during checkout.)</small></label>
            </div>
       <div class="input">
         <h6>OR</h6>
       </div> 
        <div class="input">
              <input id="billing_phone" type="number" class="input__field " name="billing_phone" aria-label="billing_phone"  >
              <label for="billing_phone" class="input__label">Billing Phone <small>(Phone number you used during checkout.)</small></label>
            </div>
...
<div class="container container--small"> 
   <div class="page-header page-header--small">
      <div class="page-header__text-wrapper text-container">
         <h1 class="heading h4 order_name"><img loading="lazy" style="height:50px;margin:auto;" src='//cdn.shopify.com/s/files/1/0637/4834/1981/t/4/assets/loading.gif?v=135655685998696985211654153040' /></h1>
         <span class="account__order-date text--subdued order_date">---</span>
      </div>
   </div>
            ...
            <div class="account__order-details">
               ...
               <div class="account__order-addresses line-item-table">
                  ...
                  <div class="account__addresses-list account__addresses-list--wide">
                     <div class="account__address account__address--auto">
                        <span class="account__address-title heading heading--small">Billing address</span>
                        <div class="account__address-details billing_address">
                           <p></p>
                        </div>
                     </div>
                     <div class="account__address account__address--auto">
                        <span class="account__address-title heading heading--small">Shipping address</span>
                        <div class="account__address-details shipping_address">
                           <p></p>
                        </div>
                     </div>
                  </div>
              ...
              <div class="account__order-addresses return_requests">
                <div class="if_returned_heading">
                  <h2 class="heading h5 mb-1">Generate Returns Request:</h2>
                <p class="mt-0 mb-1">Select following Product(s) to return</p>
                </div>
                  <span id="chooseError"></span>
                  <div class="account__addresses-list  account__addresses-list--wide" style="grid-template-columns: repeat(auto-fit,100%);">
                     <div class="account__address account__address--auto">
                       <div class="if_returned" style="display:none;">
                        <ul class="tracking_details d-flex flex-1 flex-wrap">
                         <li><strong>Tracking No:</strong><span>NA</span></li>
                         <li><strong>Credit Action:</strong><span>NA</span></li>
                         <li><strong>Return Status:</strong><span>NA</span></li>
                         <li><strong>Payment Mode:</strong><span>NA</span></li>
                         <li><strong>Refund Amount:</strong><span>NA</span></li>
                       </ul>
                        ...
                        <div class=" mt-4">
                       <a href="" class="button button--primary button--small track_url" target="_blank">GET DETAILED SCAN</a>
                       </div>
                     </div>  
                     <form id="return_request" method="post">   
                        <table class="line-item-table table table-shipment  mb-1">
                  ...
                  <tbody class="line-item-table__list shipment_html return_orders">
                     
                  </tbody>
                          <tfoot>
                            <tr>
                              <th colspan="3" style="border-bottom: 1px solid rgb(222, 222, 222);"> 
                              </th>
                            </tr>
                          </tfoot>       
               </table>
                     ...
                     <tr>
                       <th colspan="2">
                         ...
                         <ul class="d-flex m-0 p-0">
                           <li class="d-flex align-center me-2">
                             <input checked id="credit_action_1" type="radio" name="credit_action" value="Store Credit"  class="me-1" /> 
                             <label for="credit_action_1">Store Credit</label>
                           </li>
                           <li class="d-flex align-center">
                           <input id="credit_action_2"  disabled type="radio" name="credit_action" value="Refund" class="me-1"/> 
                             <label for="credit_action_2">Refund</label>
                           </li>
                         </ul>
                         <div class="bank-details mt-10 ml-10" style="display: none;">
                      ...
                      <div class="form-group row mb-0">
                        <div class="col-xs-12 col-sm-6 mb-10">
                          <label for="payee_name">Payee Name<span class="red-text">*</span> :</label>
                          <input type="text" data-required id="payee_name" class="input__field form-control">
                         </div>
                        <div class="col-xs-12 col-sm-6 mb-10">
                          <label for="account_no">Account Number<span class="red-text">*</span> :</label>
                          <input type="text" data-required id="account_no" class="input__field form-control">
                         </div>
                      </div>
                      <div class="form-group row mb-0">
                        <div class="col-xs-12 col-sm-6 mb-10">
                          <label for="bank_name">Bank Name<span class="red-text">*</span> :</label>
                          <input type="text" data-required id="bank_name" class="input__field form-control">
                         </div>
                        <div class="col-xs-12 col-sm-6 mb-10">
                          <label for="ifsc">IFSC Code<span class="red-text">*</span> :</label>
                          <input type="text" data-required id="ifsc" class="input__field form-control">
                          </div>
                      </div>
                      <div class="form-group row mb-0">
                        <div class="col-xs-12 col-sm-12 mb-10">
                          <label for="bank_address">Bank Address:</label>
                          <input type="text" id="bank_address" class="input__field form-control">
                        </div>
                      </div>
                    </div>
                       </th>
                  ...
                  <tbody class="line-item-table__list padding-tight">
                    <tr>
                      <td><big>Pickup Address<span style="color:red">*</span></big></td>
                      <td><a href="javascript:toggleAddress()"><strong style="color:#f57f7f">Edit Address</strong></a></td>
                    </tr>
...
<div class="form-group row">
   <div class="col-sm-12">
      <div class="input-box">
         <label>Enter Name <abbr class="required" title="required">*</abbr></label>
        <input type="hidden" data-required class="input__field" value="" name="first_name" >
        <input type="hidden" data-required class="input__field" value="" name="last_name" >
        
         <input type="text" data-required class="input__field fullname" value="" name="full_name" placeholder="Full Name" maxlength="60">
      </div>
   </div>
 </div> 
<div class="form-group row"> 
   <div class="col-sm-12">
      <div class="input-box">
         ...
         <input type="text" data-required class="input__field address" value="" name="street_address" placeholder="Street address">
      </div>
   </div>
   </div>
   <div class="form-group row">
   <div class="col-sm-6">
      <div class="input-box">
         ...
         <input type="email" data-required class="input__field email" value="" name="email" placeholder="Email">
      </div>
   </div>
   <div class="col-sm-6">
      <div class="input-box">
         <label>Phone <abbr class="required" title="required">*</abbr></label>
         <input type="number" data-required class="input__field phone" value="" name="phone" placeholder="Phone">
      </div>
   </div>
 </div>  
<div class="form-group row">
      <div class="col-sm-6">
         <div class="input-box">
            ...
            <select data-required name="country" id="country" class="country country1 input__field"> 
            </select>
         </div>
      </div>
      <div class="col-sm-6">
         <div class="input-box">
            ...
            <select data-required name="state" class="state input__field" id="state"> 
            </select>
         </div>
      </div>
</div>
<div class="form-group row">
   <div class="col-sm-6">
      <div class="input-box">
         ...
         <input type="text" data-required class="city input__field" value="" name="city" placeholder="Town / City">
      </div>
   </div>
   <div class="col-sm-6">
      <div class="input-box">
         <label>Postcode / Zip <abbr class="required" title="required">*</abbr></label>
         <input type="number" data-required class="pincode input__field" value="" name="pincode" placeholder="Postcode / Zip" maxlength="13">
      </div>
   </div>
 </div>
<div class="form-group row"> 
   <div class="col-sm-6">
      <div class="input-box">
         ...
         <input type="text" class="landmark input__field" value="" maxlength="150" name="landmark" placeholder="Landmark">
      </div>
   </div>
   <div class="col-sm-6">
      <div class="input-box">
        ...
        <div class="d-flex">
         ...
         <input checked class="website-radio-btn-theme address-type" type="radio" value="Home" name="address_type">&nbsp;&nbsp;Home 
          </span>
          <span  class="d-flex align-center me-2">
            <input class="website-radio-btn-theme address-type" type="radio" value="Office" name="address_type">&nbsp;&nbsp;Office/ Commercial
          </span>
            </div>
        </div>
   </div>
                         ...
                         <div class="form-group row">
                           <div class="col-sm-6">
                         <button type="button" style="padding: 6px 20px; height: auto; line-height: 2; width: auto;" class="save-pickup-address button button--primary button--full">Save</button>
                           </div>
                           </div>
                         <div class="form-group row">
                           <div class="col-sm-12">
