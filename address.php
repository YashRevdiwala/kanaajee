...
if (localStorage) {
  ...
  #clevertap-frame{
    ...
    <title>Addresses</title><link rel="canonical" href="https://peachmode.com/account/addresses"><link rel="shortcut icon" href="img/1.png"><link rel="preconnect" href="https://cdn.shopify.com">
...
<script type="application/ld+json">
      ...
      <div class="link-bar__wrapper">
        <ul class="link-bar__linklist list--unstyled" role="list">
          <li class="link-bar__link-item">
            <a href="profile.html" class="link-bar__link link--animated ">My Profile</a>
          </li>
          <li class="link-bar__link-item">
          ...
          <li class="link-bar__link-item">
            <a href="address.html" class="link-bar__link link--animated text--underlined">Addresses</a>
          </li>
          <li class="link-bar__link-item">
          ...
          <li class="link-bar__link-item">
            <a href="/kalaajee/login.html" class="link-bar__link link--animated text--subdued" data-no-instant>Logout</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="popover__content">
      <div class="popover__choice-list">
        ...
        <a href="address.html" class="popover__choice-item">
          <span class="popover__choice-label" aria-current="true">Addresses</span>
        </a>

        <a href="/kalaajee/login.html" class="popover__choice-item text--subdued" data-no-instant>
  ...
  <div class="account account--addresses">
    <div class="container container--small">
      <div class="page-header page-header--small">
        <div class="page-header__text-wrapper text-container">
          <h1 class="heading h4">Addresses <span class="bubble-count bubble-count--top">1</span></h1></div>
      </div>

      <div class="page-content">
        <div class="account__block-list"><div class="account__block-item" ><div class="account__addresses-list"><div class="account__address"><span class="account__address-title heading heading--small">Default address</span><div class="account__address-details"><p>Yash Sabhaya<br>f-601, Swastik Tower, Sarthana Jaktanka, Surat<br>1326216<br>395006 Surat GJ<br>India</p></div>
                          ...
                          <div class="account__address-actions">
                            ...
                            <form method="post" action="/account/addresses/8302380974301">
                              <input type="hidden" name="_method" value="delete">
                              <button class="link text--subdued" is="confirm-button" data-message="Are you sure you wish to delete this address?">Delete</button>
                            </form>
                          </div>
                        </div><button is="toggle-button" class="account__address account__address--empty link text--subdued" aria-controls="drawer-new-address" aria-expanded="false"><svg fill="none" focusable="false" width="24" height="24" class="icon icon--picto-address-pin   " viewBox="0 0 24 24">
    ...
    <div class="drawer__content drawer__content--padded-start"><form method="post" action="/account/addresses" id="address_form_new" accept-charset="UTF-8" class="form"><input type="hidden" name="form_type" value="customer_address" /><input type="hidden" name="utf8" value="✓" /><p class="form__info">Please fill in the fields below:</p><div class="input-row">
          ...
          <div class="input">
            <input id="address-new[company]" type="text" class="input__field input__field--text " name="address[company]" value="">
            <label for="address-new[company]" class="input__label">Company</label>
          </div>

          <div class="input">
            <input id="address-new[phone]" type="text" class="input__field input__field--text " name="address[phone]" value="">
            <label for="address-new[phone]" class="input__label">Phone number</label>
          </div>

          <div class="input">
            <input id="address-new[address1]" type="text" class="input__field input__field--text " name="address[address1]" value="">
            <label for="address-new[address1]" class="input__label">Address 1</label>
          </div>

          <div class="input">
            <input id="address-new[address2]" type="text" class="input__field input__field--text " name="address[address2]" value="">
            <label for="address-new[address2]" class="input__label">Address 2</label>
          </div>
...
<option value="Zimbabwe" data-provinces="[]">Zimbabwe</option></select><svg focusable="false" width="12" height="8" class="icon icon--chevron   " viewBox="0 0 12 8">
        ...
        <path fill="none" d="M1 1l5 5 5-5" stroke="currentColor" stroke-width="2"></path>
          ...
          <div class="checkbox-container">
            ...
            <label for="address-new[default]" class="text--subdued">Set as default</label>
          </div>
        </div>

        <button type="submit" is="loader-button" class="form__submit button button--primary button--full">Add a new address</button></form></div>
...
<script async src="https://loox.io/widget/N1gBr7V_Ih/loox.1652507684332.js?shop=peachm.myshopify.com"></script>
